...
router.get("/", async function (req, res, next) {
  try {
    ...
    // Else, if there are any valid filter parameters in the request, 
        ...
        // Ensure the minEmployees parameter has a value that is less than the maxEmployees value, if both are present
        if(req.body.minEmployees && req.body.maxEmployees && req.body.minEmployees > req.body.maxEmployees){

          throw new ExpressError("Min Employees value needs to be less than Max Employees value", 400)
